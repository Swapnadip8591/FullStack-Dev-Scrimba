function preLoadImg(url) {
    return new Promise((resolve, reject)=>{
        ...
        img.addEventListener('error', ()=> reject('image has not been loaded'))
    })
}
...
try {
    const results = await preLoadImg('https://scrimba.ams3.cdn.digitaloceanspaces.com/assets/courses/advancedjs/scenic1.jpg')
    console.log(results)
