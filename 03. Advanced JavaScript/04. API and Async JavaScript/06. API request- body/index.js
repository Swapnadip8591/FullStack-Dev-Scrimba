try {
    const response = await fetch('https://apis.scrimba.com/jsonplaceholder/posts', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'  //without this, when using default text utf-8, it will return nothing
        },
        body: JSON.stringify({
...
2. Add a headers object, content-type to application/json
*/
